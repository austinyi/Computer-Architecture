...
class MOD_mkTestBenchDecode : public Module {
 ...
 private:
  ...
  std::string DEF_IF_IF_iMem_req_pc_BITS_47_TO_44_EQ_0b0_0_OR_iM_ETC___d97;
  std::string DEF_IF_iMem_req_pc_BITS_47_TO_44_EQ_0b0_0_OR_iMem__ETC___d114;
  std::string DEF_IF_iMem_req_pc_BITS_43_TO_40_1_EQ_0b11_06_THEN_ETC___d113;
  std::string DEF_IF_IF_iMem_req_pc_BITS_47_TO_44_EQ_0b0_0_OR_iM_ETC___d72;
