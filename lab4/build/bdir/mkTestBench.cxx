...
void MOD_mkTestBench::RL_run()
{
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_5, DEF__read__h122);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
    ...
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14_4_AND_NOT_ETC___d19)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_8, DEF_data__h337);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
      dollar_fwrite(sim_hdl, this, "32,s", 2147483650u, &__str_literal_4);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
