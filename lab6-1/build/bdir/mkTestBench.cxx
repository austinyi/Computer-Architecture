...
void MOD_mkTestBench::RL_run()
{
  ...
  DEF_proc_cpuToHost_BITS_31_TO_0___d19 = DEF_ab__h328.get_whole_word(0u);
  DEF_idx__h335 = DEF_ab__h328.get_bits_in_word8(2u, 0u, 4u);
  DEF_proc_cpuToHost_BITS_63_TO_32_2_EQ_0___d15 = DEF_data__h337 == 0u;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14_4_AND_NOT_ETC___d18)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_6, DEF_data__h337);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_7, DEF__read__h122);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
