...
MOD_mkTestBench::MOD_mkTestBench(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_tState(simHdl, "tState", this, 1u, (tUInt8)0u, (tUInt8)0u),
...
void MOD_mkTestBench::RL_countCycle()
{
  ...
  DEF_x__h283 = DEF__read__h122 + 1u;
  INST_cycle.METH_write(DEF_x__h283);
...
void MOD_mkTestBench::RL_run()
{
  ...
  tUInt8 DEF_idx__h335;
  tUInt32 DEF_proc_cpuToHost_BITS_31_TO_0___d15;
  tUInt32 DEF_data__h337;
  tUWide DEF_AVMeth_proc_cpuToHost(68u, false);
  DEF__read__h122 = INST_cycle.METH_read();
  DEF_AVMeth_proc_cpuToHost = INST_proc.METH_cpuToHost();
  DEF_ab__h328 = DEF_AVMeth_proc_cpuToHost;
  DEF_data__h337 = DEF_ab__h328.get_whole_word(1u);
  DEF_proc_cpuToHost_BITS_31_TO_0___d15 = DEF_ab__h328.get_whole_word(0u);
  DEF_idx__h335 = DEF_ab__h328.get_bits_in_word8(2u, 0u, 4u);
  DEF_proc_cpuToHost_BITS_63_TO_32_2_EQ_0___d16 = DEF_data__h337 == 0u;
  DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14 = DEF_idx__h335 == (tUInt8)14u;
  DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_13___d13 = DEF_idx__h335 == (tUInt8)13u;
  DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_12___d11 = DEF_idx__h335 == (tUInt8)12u;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_12___d11)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_2, DEF_data__h337);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_13___d13)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_3, DEF_data__h337);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_4, DEF__read__h122);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
    ...
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14_4_AND_NOT_ETC___d19)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_7, DEF_data__h337);
    if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
...
unsigned int MOD_mkTestBench::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "ab__h328", 68u);
...
void MOD_mkTestBench::vcd_defs(tVCDDumpType dt, MOD_mkTestBench &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF__read__h122 = DEF__read__h122;
      ...
      ++num;
      if ((backing.DEF_ab__h328) != DEF_ab__h328)
      {
	vcd_write_val(sim_hdl, num, DEF_ab__h328, 68u);
	backing.DEF_ab__h328 = DEF_ab__h328;
      }
      ++num;
    }
    else
