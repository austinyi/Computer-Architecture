...
MOD_mkDMemory::MOD_mkDMemory(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_dMem(simHdl, "dMem", this, __str_literal_1, 26u, 32u, 0u, 67108863u, (tUInt8)0u),
...
tUInt32 MOD_mkDMemory::METH_req(tUWide ARG_req_r)
{
  ...
  DEF_x__h284 = ARG_req_r.get_whole_word(0u);
  DEF_i__h337 = ARG_req_r.get_bits_in_word32(1u, 2u, 26u);
